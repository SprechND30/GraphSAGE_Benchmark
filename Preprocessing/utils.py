...
import sys
from input_data import pollute_data
...
def load_data(dataset_str):
    ...
    #Set indices for training, validation, and testing   
    idx_test = test_idx_range.tolist()
    idx_val = range(idx_test[0]-500, idx_test[0]-1)
    ...
    return adj, features, labels, val_mask, test_mask
